...
class AnimeReviewResponse {
  ...
  factory AnimeReviewResponse.fromRawJson(String str) => AnimeReviewResponse.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory AnimeReviewResponse.fromJson(Map<String, dynamic> json) => AnimeReviewResponse(
...
class Reviewer {
  ...
  factory Reviewer.fromRawJson(String str) => Reviewer.fromJson(json.decode(str));
